...
final class RMEpisodeInfoCollectionViewCell: UICollectionViewCell {
    ...
    private func addConstraints() {
        NSLayoutConstraint.activate([
            ...
            titleLabel.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 14),
            titleLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -14),
            
            valueLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 14),
            valueLabel.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -14),
